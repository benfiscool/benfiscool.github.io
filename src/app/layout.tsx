...
export const metadata: Metadata = {
  title: 'Benjamin Freeman | Mechanical Engineer',
  description: 'Portfolio of Benjamin Freeman, Mechanical Engineer from Embry-Riddle Aeronautical University specializing in jet engine propulsion systems.',
